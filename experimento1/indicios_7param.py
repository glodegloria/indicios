...
ran=np.array([[250,400],[5,20],[0.1,1.5],[0.001,0.02],[1,3],[0,0.2],[-0.003,0.003]]) #range for parameter volume sampling to start the chains from equidistant points in the hipervolume
