...
#spec_max_mean = 0.301 #[MA-1]   #la sacas
#Q10_mean = 2.09330783 #n.u.   #la sacas 
#Kmax_mean=276# Carrying capacity of #genera at maximum food availability #la sacas  
#Kmin=4 # Carrying capacity of #genera at minimum food availability #10
#ext_slope_mean=0.00133691082 #la sacas
#ext_intercept_shelf_mean=0.170878936 #la sacas
#
#latWindow=2.5 #2.5
#lonWindow=2.5 #2.5
#
